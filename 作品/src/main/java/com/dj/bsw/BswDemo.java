...
//		BswDemo.testAlgorithm();
	...
	static void testBswCoder() throws Exception{
		String policy = "计科 硕士 研二 3of3 教师 网 云 1of2 2of3";
		String attr = "计科 硕士 研二 网";
		String message = "hello world!";
		BswCoder coder = new BswCoder();
		byte[] cipher = coder.encrypt(message.getBytes(), policy);
		byte[] plain = coder.decrypt(cipher, attr);
	...
	static void testAlgorithm() throws Exception{
		...
		try {
			Element decryptM = Bsw.decrypt(cipherText, sk, accessTree);
